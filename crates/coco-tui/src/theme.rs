...
build_theme_type!(FinalizedUiTheme {
    ...
    tool_title_name,
    tool_title_state_initing,
    tool_title_state_pending_confirmation,
    tool_title_state_executing,
    tool_title_state_completed,
    tool_title_state_failed,
    tool_title_state_cancelled,
    tool_title_dim,
    combo_title_name,
    combo_title_state_discovering,
    combo_title_state_not_found,
    combo_title_state_cancelled,
    combo_title_state_executing,
    combo_title_state_completed,
    combo_title_state_failed,
    combo_title_dim,
    bash_tab_stdout,
    bash_tab_stderr,
    bash_tab_mixed,
